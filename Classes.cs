...
namespace SVPfract
{
    ...
    public class Diurnal
    {
        ...
        private void calcTemperature(double latitude, double doy,double tMax, double tMin, double minLag, double maxLag, double nightCoef)
        {
    ...
    public class Stats
    {
        ...
        //---------------------------------------------------------------------------
        public void calcRegression(double[] x, double[] y, out double slope, out double intercept, out double rsq, out double rmse)
        {
            ...
            {
                tot += Math.Pow(x[i] - y[i], 2.0);
            }
            rmse = Math.Sqrt(tot / x.Length);
        }
